...
| 文档 | 内容 | 状态 | 预计时间 |
|------|------|------|----------|
| [协议设计](03-simple-chat/protocol-design.md) | 消息格式、通信协议 | 📝 待创建 | 2天 |
| [消息处理](03-simple-chat/message-handling.md) | 消息解析、验证、路由 | 📝 待创建 | 2天 |
| [多线程基础](03-simple-chat/threading-basics.md) | 并发处理多个客户端 | 📝 待创建 | 2天 |
| [错误处理](03-simple-chat/error-handling.md) | 网络异常、连接管理 | 📝 待创建 | 1天 |

### 🗄️ 第4章：数据库与用户系统
| 文档 | 内容 | 状态 | 预计时间 |
|------|------|------|----------|
| [SQLite基础](04-database-user-system/sqlite-basics.md) | 数据库操作、SQL语句 | 📝 待创建 | 2天 |
| [数据库设计](04-database-user-system/database-design.md) | 表结构设计、关系建模 | 📝 待创建 | 2天 |
| [用户认证](04-database-user-system/user-authentication.md) | 注册、登录、会话管理 | 📝 待创建 | 2天 |
| [数据模型](04-database-user-system/data-models.md) | ORM模式、数据访问层 | 📝 待创建 | 1天 |
